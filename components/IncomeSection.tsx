  ...
  return (
    <div className="space-y-4">
      <p className="text-gray-600 mb-4">
        Add all your sources of income. This could include salary, freelance
        work, investments, or other income streams.
      </p>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                {...register(`incomeItems.${index}.source`, {
                  required: 'Source is required',
                })}
                placeholder="e.g., Salary, Freelance"
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              {errors.incomeItems?.[index]?.source && (
            ...
            <div>
              ...
              <input
                {...register(`incomeItems.${index}.amount`, {
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              {errors.incomeItems?.[index]?.amount && (
                <p className="text-red-600 text-sm mt-1">
            ...
            <div className="flex items-end gap-2">
              <div className="flex-1">
                ...
                <select
                  {...register(`incomeItems.${index}.frequency`, {
      ...
      <button
        type="button"
        onClick={() => append({ source: '', amount: 0, frequency: 'monthly' })}
