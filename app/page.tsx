    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
          <Link
            href="/life-design"
            className="group rounded-lg border-2 border-blue-500 bg-blue-50 px-5 py-4 transition-colors hover:border-blue-600 hover:bg-blue-100"
          >
            ...
            <p className="m-0 max-w-[30ch] text-sm text-blue-800">
              Design your ideal life and discover the income needed to get there
            </p>
          </Link>
